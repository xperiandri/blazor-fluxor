...
## What's new
### New in 0.0.11
  - Removed IState<T> and replaced with IStateProvider<T>. Use `@inject IStateProvider<MyState> MyState` and the state provider as a function call `Name is @MyState().Name`
### New in 0.0.10
